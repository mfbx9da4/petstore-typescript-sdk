...
* [updateUserJson](docs/sdks/user/README.md#updateuserjson) - Update user resource.
* [updateUserRaw](docs/sdks/user/README.md#updateuserraw) - Update user resource.
* [updateUserForm](docs/sdks/user/README.md#updateuserform) - Update user resource.
* [deleteUser](docs/sdks/user/README.md#deleteuser) - Delete user resource.
...
- [`storeDeleteOrder`](docs/sdks/store/README.md#deleteorder) - Delete purchase order by identifier.
...
- [`userDeleteUser`](docs/sdks/user/README.md#deleteuser) - Delete user resource.
...
- [`userUpdateUserForm`](docs/sdks/user/README.md#updateuserform) - Update user resource.
- [`userUpdateUserJson`](docs/sdks/user/README.md#updateuserjson) - Update user resource.
- [`userUpdateUserRaw`](docs/sdks/user/README.md#updateuserraw) - Update user resource.
...
async function run() {
  const result = await petstore.pet.updatePetRaw(
    bytesToStream(
