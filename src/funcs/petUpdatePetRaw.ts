 ...
 */
export function petUpdatePetRaw(
  client: PetstoreCore,
  request: ReadableStream<Uint8Array> | Blob | ArrayBuffer | Uint8Array,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdatePetRawResponse | undefined,
    | PetstoreError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, types$.optional(operations.UpdatePetRawResponse$inboundSchema)),
    M.bytes(
      200,
      types$.optional(operations.UpdatePetRawResponse$inboundSchema),
      { ctype: "application/xml" },
    ),
    M.fail([400, 404, 422, "4XX"]),
    M.fail("5XX"),
    M.nil(
      "default",
      types$.optional(operations.UpdatePetRawResponse$inboundSchema),
