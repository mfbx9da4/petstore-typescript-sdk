 ...
 * Add a new pet to the store.
 */
export function petAddPetJson(
  client: PetstoreCore,
  request: components.Pet,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AddPetJsonResponse | undefined,
    | PetstoreError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(components.Pet$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, types$.optional(operations.AddPetJsonResponse$inboundSchema)),
    M.bytes(200, types$.optional(operations.AddPetJsonResponse$inboundSchema), {
    ...
    M.nil(
      "default",
      types$.optional(operations.AddPetJsonResponse$inboundSchema),
    ),
  )(response, req);
  if (!result.ok) {
