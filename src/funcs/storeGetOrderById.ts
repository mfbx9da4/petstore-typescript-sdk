...
export function storeGetOrderById(
  ...
  Result<
    operations.GetOrderByIdResponse | undefined,
    | PetstoreError
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => z.parse(operations.GetOrderByIdRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, types$.optional(operations.GetOrderByIdResponse$inboundSchema)),
    M.bytes(
      200,
      types$.optional(operations.GetOrderByIdResponse$inboundSchema),
