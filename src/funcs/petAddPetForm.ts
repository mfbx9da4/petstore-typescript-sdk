 ...
 * Add a new pet to the store.
 */
export function petAddPetForm(
  client: PetstoreCore,
  request: components.Pet,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AddPetFormResponse | undefined,
    | PetstoreError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, types$.optional(operations.AddPetFormResponse$inboundSchema)),
    M.bytes(200, types$.optional(operations.AddPetFormResponse$inboundSchema), {
    ...
    M.nil(
      "default",
      types$.optional(operations.AddPetFormResponse$inboundSchema),
    ),
  )(response, req);
  if (!result.ok) {
