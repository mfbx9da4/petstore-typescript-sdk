...
export function userGetUserByName(
  ...
  Result<
    operations.GetUserByNameResponse | undefined,
    | PetstoreError
...
> {
  const input: operations.GetUserByNameRequest = {
    username: username,
  };

  const parsed = safeParse(
    input,
    (value) => z.parse(operations.GetUserByNameRequest$outboundSchema, value),
  ...
  >(
    M.json(
      200,
      types$.optional(operations.GetUserByNameResponse$inboundSchema),
    ),
    M.bytes(
      200,
      types$.optional(operations.GetUserByNameResponse$inboundSchema),
