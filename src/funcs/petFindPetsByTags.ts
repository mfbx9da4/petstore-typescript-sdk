...
export function petFindPetsByTags(
  ...
  Result<
    operations.FindPetsByTagsResponse | undefined,
    | PetstoreError
...
> {
  const input: operations.FindPetsByTagsRequest = {
    tags: tags,
  };

  const parsed = safeParse(
    input,
    (value) => z.parse(operations.FindPetsByTagsRequest$outboundSchema, value),
  ...
  >(
    M.json(
      200,
      types$.optional(operations.FindPetsByTagsResponse$inboundSchema),
    ),
    M.bytes(
      200,
      types$.optional(operations.FindPetsByTagsResponse$inboundSchema),
