 ...
 */
export function userUpdateUserForm(
  client: PetstoreCore,
  username: string,
...
> {
  const input: operations.UpdateUserFormRequest = {
    username: username,
    body: body,
  };
  ...
  const parsed = safeParse(
    input,
    (value) => z.parse(operations.UpdateUserFormRequest$outboundSchema, value),
  ...
  const body$ = Object.entries(payload.body || {}).map(([k, v]) => {
