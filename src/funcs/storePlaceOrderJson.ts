 ...
 */
export function storePlaceOrderJson(
  client: PetstoreCore,
  request?: components.Order | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.Order | undefined,
    | PetstoreError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(z.optional(components.Order$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, types$.optional(components.Order$inboundSchema)),
    M.fail([400, 422, "4XX"]),
    M.fail("5XX"),
    M.nil("default", types$.optional(components.Order$inboundSchema)),
  )(response, req);
  if (!result.ok) {
