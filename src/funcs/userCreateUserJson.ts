 ...
 */
export function userCreateUserJson(
  client: PetstoreCore,
  request?: components.User | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateUserJsonResponse | undefined,
    | PetstoreError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(z.optional(components.User$outboundSchema), value),
  ...
  >(
    M.json(
      200,
      types$.optional(operations.CreateUserJsonResponse$inboundSchema),
    ),
    M.bytes(
      200,
      types$.optional(operations.CreateUserJsonResponse$inboundSchema),
